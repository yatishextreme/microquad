// colocar as funcoes do lcd como ponteiro de func
// testar o tipo de item bool    #######    VER MENU.H    ##########
// usar o tipo bool no codigo
#include "stdio.h"
#include "stdlib.h"
#include "string.h"
#include "color.h"
    ...
    switch(oMenu->eMenuState){   
        case STATE_IDLE:
            switch(act){
                ...
                case ACTION_UP:
                    delay_set(DELAY_STICK_INDEX, STICK_DELAY);
                ...
                case ACTION_LEFT:
                    delay_set(DELAY_STICK_INDEX, 50);
                    oMenu->eMenuState = STATE_WAIT_BACK;
        ...
        case STATE_WAIT_BACK:
            if((act == ACTION_NONE) || (delay_poll(DELAY_STICK_INDEX))){
                oMenu->eMenuState = STATE_IDLE;
                result = RESP_NONE;
            }
            else{
